...
from src.reports import analyze_cashback_categories, logger
...
def analyze_cashback_categories_safe(data, year, month):
    """Безопасная обертка для analyze_cashback_categories."""
    try:
        return analyze_cashback_categories(data, year, month)
...
def test_analyze_cashback_categories_logging_success(mock_logger, mock_report_data):
    """Тест успешного выполнения с валидными данными."""
